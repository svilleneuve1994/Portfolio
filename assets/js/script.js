...
(function ($) {
  ...
  $( "#portfolio-icon" ).click(function( event ) {
    $( "#portfolio-window" ).dialog( "open" );
    event.preventDefault();
  });

  $( "#skills-icon" ).click(function( event ) {
    $( "#skills-window" ).dialog( "open" );
    event.preventDefault();
  });
  ...
  $( "#about-icon" ).click(function( event ) {
    $( "#about-window" ).dialog( "open" );
    event.preventDefault();
  });
  ...
  $( "#misc-icon" ).click(function( event ) {
    $( "#misc-window" ).dialog( "open" );
    event.preventDefault();
  });
